...
const ProjectItem = ({ project, index, onMouseEnter, onMouseLeave, isActive, isIdle, setRef }) => {
  ...
  return (
    <li 
      ref={el => {
        itemRef.current = el;
        if (typeof setRef === 'function') setRef(el);
      }}
          ...
          <ul className="project-list" role="list">
            {PROJECTS_DATA.map((project, index) => (
              <ProjectItem
                ...
                isIdle={isIdle}
                setRef={el => projectItemsRef.current[index] = el}
              />
            ))}
          </ul>
        </main>
